...
% An example of texton learning. The textons are learned class by class. You can also solve representation coefficient by L_1 norm minimization or the method in the paper.
%TrainNumPerClass:number of training samples per class
%ClassNum:class number
%PicNumPerClass:number of samples per class
%MR8Folder:MR8 feature folder
%nt: texton number per class
%S:sampling rate
%P:number of selected textons (smaller than the dimension of the feature. S=3, P=7)
...
%tic 
 ...
 iteration=1;
while (iteration<20)
    % solve alpha:representation coefficient per class
